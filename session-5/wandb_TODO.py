...
class WandbLogger(Logger):
    ...
    def log_reconstruction_training(
        ...
        wandb.log({"train reconstruction loss": train_loss_avg}, epoch)

        # TODO: Log validation reconstruction loss to wandb
        wandb.log({"validation reconstruction loss": val_loss_avg}, epoch)

        # TODO: Log a batch of reconstructed images from the validation set
        image = wandb.Image(reconstruction_grid, caption=f"random field")
        
        wandb.log({"reconstructed image": image})
